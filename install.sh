...
echo "  vocabularyplus # to launch main.py"
echo "  vocabularyplus create # to launch create_vocab_file.py"
echo "  vp # alternative to vocabularyplus"
echo "  vp create # alternative to vocabularyplus create"
echo
